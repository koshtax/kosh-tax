...
def generate_form16_pdf(data, is_trial=False):
    ...
    and Monthly Salary Statement layout with real dynamic entries extracted from PDF blocks.
    """
    try:
        ...
        # Get real extracted monthly entries or create a fallback single/double entry based on extracted data
...
<table>
  ...
  <tr>
    ...
    <td class="right">{{ entry.basic }}</td>
    <td class="right">{{ entry.da }}</td>
    <td class="right">{{ entry.hra }}</td>
    <td class="right">{{ entry.medical }}</td>
    <td class="right">{{ entry.gross }}</td>
    <td class="right">{{ entry.gpf }}</td>
    <td class="right">{{ entry.gli }}</td>
    <td class="right">{{ entry.ptax }}</td>
    <td class="right">{{ entry.gpf + entry.gli + entry.ptax }}</td>
    <td class="right">{{ entry.tds }}</td>
    <td class="right">{{ entry.net }}</td>
  </tr>
  {% endfor %}
  <tr class="bold" style="background-color: #e6e6e6;">
    ...
    <td class="right">{{ gpf + 720 + ptax }}</td>
