...
<div class="page">
    ...
    <table>
        ...
        <table>
        <tr>
            <td width="25%"><b>PAN of the Deductor</b><br>{{ data.ddo_pan or '......................' }}</td>
            <td width="25%"><b>TAN of the Deductor</b><br>{{ data.ddo_tan or '......................' }}</td>
            <td width="25%"><b>PAN of the Employee</b><br>{{ data.pan }}</td>
            <td width="25%"><b>Employee Reference No.</b><br>{{ data.gpf or "-" }}</td>
        </tr>
        <tr>
            <td colspan="2">
...
def generate_form16_pdf(data: Dict[str, Any], is_trial: bool = False) -> bytes:
    ...
    rounded_total_income = round(total_income / 10) * 10
        # Slab Breakdown (Directly from Tax Calculator Dictionary)
    tax_slab_5 = data.get('tax_slab_5', 0)
    tax_slab_10 = data.get('tax_slab_10', 0)
    tax_slab_15 = data.get('tax_slab_15', 0)
    tax_slab_20 = data.get('tax_slab_20', 0)
    tax_slab_25 = data.get('tax_slab_25', 0) 
    tax_slab_30 = data.get('tax_slab_30', 0)
