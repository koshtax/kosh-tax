...
def generate_form16_pdf(data, is_trial=False):
    """
    Generate Form 16 PDF safely avoiding WeasyPrint positional argument mismatch.
    """
    try:
...
"""
    ...
    # Safe PDF generation using temporary file to avoid WeasyPrint signature mismatch crash
