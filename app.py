...
# ================= 4-PAGE BILINGUAL PRINT TEMPLATE (WITH ROBUST FONTS & STATUTORY ACCURACY) =================
...
<style>
  ...
  * { 
  ...
  .title-main { font-size: 11.5px; font-weight: 700; line-height: 1.3; }
  .title-sub { font-size: 13px; font-weight: 700; line-height: 1.3; margin: 2px 0; }
...
<div class="sheet-page">
  {% if is_trial %}<div class="watermark-layer">TRIAL COPY — FOR VERIFICATION ONLY</div>{% endif %}
  ...
  <table class="border" style="margin-top: 6px;">
    ...
    <tr>
      ...
      <td colspan="2" style="padding: 4px 6px;">
        <b>रु० {{ "%.2f"|format(tax.taxable_income) }} पर देय आयकर (Tax Slabs):</b><br>
...
<div class="sheet-page">
  ...
  <div class="center" style="font-size: 8px; margin-bottom: 8px;">
  ...
  <table class="border">
    <tr>
      <td style="width: 50%; vertical-align: top; height: 55px;">
  ...
  <div style="font-weight: 700; font-size: 8.5px; margin-top: 6px;">
  ...
  <table class="border">
    ...
    <tr class="center">
      <td>Quarter 1 to 3</td><td>Consolidated Treasury Adjustment</td><td class="right">--</td>
      <td class="right">{{ "%.2f"|format(totals.q1_3_tds) }}</td><td class="right">{{ "%.2f"|format(totals.q1_3_tds) }}</td>
    </tr>
    <tr class="center">
  ...
  <div style="margin-top: 8px; font-size: 8.5px; border-top: 0.8px solid #000; padding-top: 5px;">
    <div class="center bold" style="margin-bottom: 3px;">Verification</div>
...
<div class="sheet-page">
  ...
  <div class="sign-area" style="margin-top: 30px;">
    <table class="no-border">
      <tr><td>Place: {{ ddo.city or ddo.district }}</td><td style="text-align: right;">Signature of DDO</td></tr>
    </table>
  </div>
</div>
...
<div class="sheet-page">
  ...
  <div class="center title-sub">मासिक वेतन एवं कटौतियों की विवरणी (Monthly Salary Ledger)</div>
  ...
  <div class="sign-area" style="margin-top: 25px;">
    <table class="no-border">
      <tr><td>हस्ताक्षर करदाता</td><td style="text-align: right;">निकासी एवं व्ययन पदाधिकारी</td></tr>
    </table>
  </div>
</div>
</body>
...
def render_full_employee_suite(is_admin_mode=False, prefix="emp"):
    ...
    slip_up = st.file_uploader(
        "Upload Salary Slip (PDF) — Block to District, 7th CPC Matrix, Pension & Arrear auto-detect ho jayenge[span_4](start_span)[span_4](end_span):", 
        type=["pdf"], 
        key=f"{prefix}_slip"
    )
