Nahi boss, pichle message mein code ke aage ka hissa (jaise generate_pdf_bundle function ke baaki parts aur Admin/Public routes) cut gaya tha.
Ye lijiye aapka 100% poora aur complete app.py script ek hi jagah bina kisi kanta-kanti ke:
...
<div class="page-landscape">
  ...
  <table class="border" style="font-size: 10px; margin-top: 6px;">
    ...
    <tr>
      ...
      <td class="right" style="padding: 4px;">{{ "%.0f"|format(r.net) }}</td>
    </tr>
    {% endfor %}
...
def generate_pdf_bundle(ddo_dict, emp_dict, full_records, tax_summary, deposits=None, decl_dict=None, is_trial=False):
    ...
    totals['ptax'] = sum(r.get('ptax', 0) for r in full_records)
