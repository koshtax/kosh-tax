...
# ALL 24 JHARKHAND DISTRICTS & BLOCKS MAPPING
...
# ================= 4-PAGE BILINGUAL PRINT TEMPLATE (WITH OPTIONAL TRIAL WATERMARK) =================
...
<div class="sheet-page">
  {% if is_trial %}
  <div class="trial-watermark">TRIAL COPY — FOR VERIFICATION ONLY</div>
  {% endif %}
...
<!-- PAGE 2: FORM 16 PART A (EXACT STATUTORY MATCH) -->
<div class="sheet-page">
  {% if is_trial %}
  <div class="trial-watermark">TRIAL COPY — FOR VERIFICATION ONLY</div>
  {% endif %}

  <div class="center title-2">T.D.S.<br>FORM NO. 16<br>PART A</div>
  <div class="center title-1" style="font-size: 8.5px; margin-bottom: 6px;">
  ...
  <div style="font-weight: bold; font-size: 8.5px; margin-top: 4px;">
    Summary of amount paid/credited and tax deducted at source thereon in respect of the employee
  </div>
  <table class="border">
    <tr class="bg-gray center bold" style="font-size: 8px;">
      <th>Quarter(s)</th><th>Receipt Numbers of original quarterly statements of TDS under sub-section (3) of section 200</th>
      <th>Amount paid/credited</th><th>Amount of tax deducted (Rs.)</th><th>Amount of tax deposited/remitted (Rs.)</th>
    </tr>
    <tr class="center">
  ...
  <!-- STATUTORY DDO VERIFICATION DECLARATION -->
...
<div class="sheet-page">
  ...
  <div class="sign-area"><table class="no-border"><tr><td>Place: {{ ddo.city or ddo.district }}</td><td style="text-align: right;">Signature of DDO</td></tr></table></div>
</div>
...
def generate_pdf_bundle(ddo_dict, emp_dict, full_records, tax_summary, deposits=None, decl_dict=None, is_trial=False):
    ...
    trial_watermark_css = """
      .trial-watermark {
        ...
        z-index: 9999;
        pointer-events: none;
        border: 4px dashed rgba(220, 53, 69, 0.25);
        padding: 20px;
        letter-spacing: 2px;
      }
    """ if is_trial else ""
...
def render_full_employee_suite(is_admin_mode=False, prefix="emp"):
    ...
    slip_up = st.file_uploader(
        "Upload Salary Slip (PDF) — Block to District, 7th CPC Matrix, Pension & Arrear auto-detect ho jayenge[span_1](start_span)[span_1](end_span):", 
        type=["pdf"], 
        key=f"{prefix}_slip"
    )
